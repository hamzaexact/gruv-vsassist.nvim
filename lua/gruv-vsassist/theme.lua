...
theme.set_highlights = function(opts)
    ...
    hl(0, "@variable.rust", { fg = c.gruvBlue, bg = "NONE" })
    ...
    hl(0, "@type.builtin.rust", { fg = c.vscMediumBlue, bg = "NONE" })
    hl(0, "@type.qualifier.rust", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "@function.rust", { fg = c.vsaGold, bg = "NONE" })
    hl(0, "@function.builtin.rust", { fg = c.vsaGold, bg = "NONE" })
    hl(0, "@function.call.rust", { fg = c.vsaOrange, bg = "NONE" })
    hl(0, "@method.rust", { fg = c.vsaOrange, bg = "NONE" })
    hl(0, "@method.call.rust", { fg = c.vsaOrange, bg = "NONE" })
    ...
    hl(0, "@float.rust", { fg = c.gruvPurple, bg = "NONE" })
    ...
    hl(0, "@constant.builtin.rust", { fg = c.vscMediumBlue, bg = "NONE" })
    ...
    hl(0, "rustCrate", { fg = c.gruvRed, bg = "NONE" })
    hl(0, "rustImport", { fg = c.gruvRed, bg = "NONE" })
    ...
    hl(0, "rustDeriveHelper", { fg = c.vsaOrange, bg = "NONE" })

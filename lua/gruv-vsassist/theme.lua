...
theme.set_highlights = function(opts)
    ...
    hl(0, "@namespace.rust", { fg = c.gruvBlue, bg = "NONE" })
    ...
    hl(0, "rustKeyword", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustType", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustString", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustNumber", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustBoolean", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustFuncName", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustComment", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustMacro", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustAttribute", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustModName", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustStructName", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustEnumName", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustTraitName", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustImplName", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustConstant", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustLifetime", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustOperator", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustDerive", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustQuestionMark", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustArrow", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustCrate", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustImport", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustPubScope", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustSelfKgeyword", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustSuper", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustModPathSep", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustAssert", { fg = c.customGreen, bg = "NONE" })
    hl(0, "rustDeriveHelper", { fg = c.customGreen, bg = "NONE" })

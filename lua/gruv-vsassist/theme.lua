...
theme.set_highlights = function(opts)
    ...
    hl(0, "PmenuSel", {
        fg = isDark and c.vscPopupFront or c.vscBack,
    ...
    hl(0, "@float.rust", { fg = c.vsaPurple, bg = "NONE" })
    hl(0, "@function.rust", { fg = c.vsaSoftYellow, bg = "NONE" })
    hl(0, "@function.builtin.rust", { fg = c.vsaSoftYellow, bg = "NONE" })
    hl(0, "@function.call.rust", { fg = c.vsaSoftYellow, bg = "NONE" })
    ...
    hl(0, "@module.rust", { fg = c.customGreen, bg = "NONE" })
    hl(0, "@namespace.rust", { fg = c.customGreen, bg = "NONE" })
    hl(0, "@number.rust", { fg = c.gruvPurple, bg = "NONE" })
    hl(0, "@operator.rust", { fg = c.vscGray, bg = "NONE" })
    hl(0, "@parameter.rust", { fg = c.gruvFg1, bg = "NONE" })
    hl(0, "@property.rust", { fg = c.gruvFg1, bg = "NONE" })
    hl(0, "@punctuation.bracket.rust", { fg = c.vscGray, bg = "NONE" })
    hl(0, "@punctuation.delimiter.rust", { fg = c.vscGray, bg = "NONE" })
    hl(0, "@string.rust", { fg = c.vscOrange, bg = "NONE" })
    hl(0, "@string.escape.rust", { fg = c.vscYellowOrange, bg = "NONE", bold = true })
    hl(0, "@type.rust", { fg = c.vsaGold, bg = "NONE" })
    ...
    -- -- Rust - Enhanced for better visual distinction
    -- hl(0, "rustKeyword", { fg = c.gruvRed, bg = "NONE" })
    -- hl(0, "rustType", { fg = c.vsaGold, bg = "NONE" })
    -- hl(0, "rustString", { fg = c.vscOrange, bg = "NONE" })
    -- hl(0, "rustNumber", { fg = c.gruvPurple, bg = "NONE" })
    -- hl(0, "rustBoolean", { fg = c.gruvRed, bg = "NONE" })
    -- hl(0, "rustFuncName", { fg = c.vsaSoftYellow, bg = "NONE" })
    -- hl(0, "rustComment", { fg = c.vscGreen, bg = "NONE" })
    -- hl(0, "rustMacro", { fg = c.gruvPurple, bg = "NONE" })
    -- hl(0, "rustAttribute", { fg = c.vsaGold, bg = "NONE" })
    -- hl(0, "rustModName", { fg = c.customGreen, bg = "NONE" })
    -- hl(0, "rustStructName", { fg = c.vsaGold, bg = "NONE" })
    -- hl(0, "rustEnumName", { fg = c.vsaGold, bg = "NONE" })
    -- hl(0, "rustTraitName", { fg = c.vsaGold, bg = "NONE" })
    -- hl(0, "rustImplName", { fg = c.gruvBlue, bg = "NONE" })
    -- hl(0, "rustConstant", { fg = c.vsaLightGreen, bg = "NONE" })
    -- hl(0, "rustLifetime", { fg = c.vscYellowOrange, bg = "NONE" })
    -- hl(0, "rustOperator", { fg = c.vscGray, bg = "NONE" })
    -- hl(0, "rustDerive", { fg = c.gruvPurple, bg = "NONE" })
    -- hl(0, "rustQuestionMark", { fg = c.vscGray, bg = "NONE" })
    -- hl(0, "rustArrow", { fg = c.vscGray, bg = "NONE" })
    -- hl(0, "rustCrate", { fg = c.customGreen, bg = "NONE" })
    -- hl(0, "rustImport", { fg = c.customGreen, bg = "NONE" })
    -- hl(0, "rustPubScope", { fg = c.gruvRed, bg = "NONE" })
    -- hl(0, "rustSelfKeyword", { fg = c.gruvRed, bg = "NONE" })
    -- hl(0, "rustSuper", { fg = c.gruvRed, bg = "NONE" })
    -- hl(0, "rustModPathSep", { fg = c.customGreen, bg = "NONE" })
...
theme.link_highlight = function()
  local c = require("gruv-vsassist.colors").get_colors()
    ...
    -- hl(0, "@lsp.type.namespace.rust", {fg = c.customGreen,bg = "NONE",})
    ...
    -- hl(0, "@lsp.typemod.parameter.mutable.rust", { link = "@parameter" })
    -- hl(0, "@lsp.typemod.selfKeyword.mutable.rust", { link = "@keyword" })
